...
export const useAuthStore = defineStore('auth', () => {
  ...
  const isRestoran = computed(() => trenutniKorisnik.value?.role === 'restaurant')
  const isDostavljac = computed(() => trenutniKorisnik.value?.role === 'courier')
  const isKupac = computed(() => trenutniKorisnik.value?.role === 'customer')
